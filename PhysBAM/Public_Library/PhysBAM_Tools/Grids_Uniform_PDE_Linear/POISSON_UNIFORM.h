...
public:
    ...
    using LAPLACE_UNIFORM<T_GRID>::psi_N;using LAPLACE_UNIFORM<T_GRID>::psi_D;
    using LAPLACE_UNIFORM<T_GRID>::periodic_boundary;using LAPLACE_UNIFORM<T_GRID>::filled_region_colors;
