...
{PHYSBAM_NOT_IMPLEMENTED();}
//#####################################################################
template void Compute_Cut_Geometries(const GRID<VECTOR<float,1> >&,const int,COLLISION_GEOMETRY_COLLECTION_POLICY<GRID<VECTOR<float,1> > >::GRID_BASED_COLLISION_GEOMETRY&,ARRAY<CUT_CELLS<float,1>*,VECTOR<int,1> >&);
template void Compute_Cut_Geometries(const GRID<VECTOR<float,2> >&,const int,COLLISION_GEOMETRY_COLLECTION_POLICY<GRID<VECTOR<float,2> > >::GRID_BASED_COLLISION_GEOMETRY&,ARRAY<CUT_CELLS<float,2>*,VECTOR<int,2> >&);
template void Compute_Cut_Geometries(const GRID<VECTOR<float,3> >&,const int,COLLISION_GEOMETRY_COLLECTION_POLICY<GRID<VECTOR<float,3> > >::GRID_BASED_COLLISION_GEOMETRY&,ARRAY<CUT_CELLS<float,3>*,VECTOR<int,3> >&);
#ifndef COMPILE_WITHOUT_DOUBLE_SUPPORT
template void Compute_Cut_Geometries(const GRID<VECTOR<double,1> >&,const int,COLLISION_GEOMETRY_COLLECTION_POLICY<GRID<VECTOR<double,1> > >::GRID_BASED_COLLISION_GEOMETRY&,ARRAY<CUT_CELLS<double,1>*,VECTOR<int,1> >&);
template void Compute_Cut_Geometries(const GRID<VECTOR<double,2> >&,const int,COLLISION_GEOMETRY_COLLECTION_POLICY<GRID<VECTOR<double,2> > >::GRID_BASED_COLLISION_GEOMETRY&,ARRAY<CUT_CELLS<double,2>*,VECTOR<int,2> >&);
template void Compute_Cut_Geometries(const GRID<VECTOR<double,3> >&,const int,COLLISION_GEOMETRY_COLLECTION_POLICY<GRID<VECTOR<double,3> > >::GRID_BASED_COLLISION_GEOMETRY&,ARRAY<CUT_CELLS<double,3>*,VECTOR<int,3> >&);
#endif
}
}
